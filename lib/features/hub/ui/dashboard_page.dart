                ...
                child: Column(
                  ...
                  children: [
                    ...
                    Text(
                      ...
                      style: TextStyle(
                        color: Theme.of(context).brightness == Brightness.dark ? Colors.white70 : MeireTheme.primaryColor.withValues(alpha: 0.1),
                        fontWeight: FontWeight.bold,
                        fontSize: 14,
                      ),
                    ),
  ...
  Widget _buildActionItem(BuildContext context, IconData icon, String title,
    ...
    return Material(
      ...
      child: InkWell(
        ...
        highlightColor: MeireTheme.accentColor.withValues(alpha: 0.1),
        child: Container(
          ...
          child: Row(
            children: [
              Container(
                padding: const EdgeInsets.all(12),
                decoration: BoxDecoration(
                  color: isDark ? Colors.white.withValues(alpha: 0.1) : MeireTheme.iceGray,
                  borderRadius: BorderRadius.circular(12),
                ),
                child: Icon(icon,
                    color: isDark
      ...
      child: const Column(
        ...
        children: [
          Row(
            mainAxisAlignment: MainAxisAlignment.spaceBetween,
            children: [
              Text("Performance Semestral",
                  style: TextStyle(fontWeight: FontWeight.bold)),
              Icon(Icons.description, color: MeireTheme.primaryColor),
            ],
          ),
          SizedBox(height: 24),
          SizedBox(
